    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                <h1 class="display-5 mb-4">Dental Center &#x2764;</h1>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select class="form-control" id="spec">
                        ...
                        <option value="1">Parodontologija i oralna medicina</option>
                        <option value="2">Dečija stomatologija</option>
                        <option value="3">Maskilofacijalna hirurgija</option>
                    </select>
                </div>
                <div class="col-md-6">
